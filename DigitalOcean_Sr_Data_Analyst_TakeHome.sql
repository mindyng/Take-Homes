--Run here: https://www.db-fiddle.com/f/saufkLqU8UJfmrUbTJju5j/3
...
SELECT *
, AVG(csat) OVER (ORDER BY month DESC --this is so that following can go backwards in time
  ROWS BETWEEN CURRENT ROW AND 5 FOLLOWING) AS csat_six_mo
FROM 
(
